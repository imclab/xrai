...
| AudioBridge | `Scripts/Bridges/AudioBridge.cs` | Primary audio bands (global shader props) |
| EnhancedAudioProcessor (legacy) | `Scripts/Audio/EnhancedAudioProcessor.cs` | Legacy frequency bands |
...
| AudioBridge | Complete | Primary audio bands |
| EnhancedAudioProcessor | Legacy | Superseded by AudioBridge |

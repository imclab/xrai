...
## Audio
- [x] AudioBridge provides audio bands (primary)
- [x] EnhancedAudioProcessor uses FFT (legacy)
...
- [x] ARDepthSource + VFXARBinder is the primary binding path
- [x] VFXBinderManager auto-binds all VFX (legacy)

...
#pragma warning restore 0649
        ...
        [Tooltip("Default import options.")] public EditTimeImportOptions defaultImportOptions;

        public TiltBrushToolkit.BrushManifest brushManifest;

        [Tooltip("Base PBR opaque material to use when importing assets.")] [FormerlySerializedAs("basePbrMaterial")]
        ...
        [Tooltip("Authentication settings.")] public IcosaAuthConfig authConfig;
        [Tooltip("Cache settings.")] public IcosaCacheConfig cacheConfig;

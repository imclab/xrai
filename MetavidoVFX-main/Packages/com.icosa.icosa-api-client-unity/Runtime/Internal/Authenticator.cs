...
using IcosaClientInternal.entitlement;
...
namespace IcosaClientInternal
{
    ...
    public class Authenticator : MonoBehaviour
    {
        ...
        public static void Initialize(IcosaAuthConfig config)
        {
        ...
        public void Authenticate(bool interactive, Action<IcosaStatus> callback)
        {
            if (!instance.IsAuthenticationSupported)
            {
        ...
        public void Authenticate(string accessToken, string refreshToken, Action<IcosaStatus> callback)
        {
            if (!instance.IsAuthenticationSupported)
            {
                callback(IcosaStatus.Error("Authentication is not supported on this platform."));
        ...
        /// </summary>
        public void Reauthorize(Action<IcosaStatus> callback)
        {
            if (!instance.IsAuthenticationSupported)
            {
                callback(IcosaStatus.Error("Authentication is not supported on this platform."));

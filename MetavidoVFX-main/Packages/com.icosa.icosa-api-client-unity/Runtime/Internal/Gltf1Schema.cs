...
namespace IcosaClientInternal
{
    ...
    public sealed class Gltf1Root : GltfRootBase
    {
        ...
        public override void Dereference(IUriLoader uriLoader = null, IcosaFormat gltfFormat = null)
        {
    ...
    public class Gltf1Primitive : GltfPrimitiveBase
    {
        ...
        {
            get { return materialPtr; }
        }

        public override GltfAccessorBase IndicesPtr
        {
            get { return indicesPtr; }
        }
    ...
    public class Gltf1Material : GltfMaterialBase
    {
        ...
        {
            get { return techniquePtr != null ? techniquePtr.extras : null; }
        }

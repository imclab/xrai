...
namespace IcosaApiClient
{
    ...
    [Serializable]
    [AutoStringifiable]
    public struct IcosaImportOptions
    {
        ...
        /// etc) on import. Rather, an enumerator will be returned (mainThreadThrottler) in IcosaImportResult
        ...
        /// </summary>
        [HideInInspector] public bool clientThrottledMainThread;

        /// <summary>
        /// Returns a default set of import options.
        /// </summary>
        public static IcosaImportOptions Default()
        {
            IcosaImportOptions options = new IcosaImportOptions();

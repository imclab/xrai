...
public static class FluoSetupAutomation
{
    ...
    {
        var rendererDataPath = "Assets/Fluo/04 Visualizer/Settings/VisualRenderer.asset";
    ...
    static void SetupScene()
    {
        ...
        if (vfx != null)
        {
            ...
            var multiplexTarget = AssetDatabase.LoadAssetAtPath<RenderTexture>("Assets/Fluo/01 Input/Targets/VideoInPrefiltered.renderTexture");
            var blurTarget = AssetDatabase.LoadAssetAtPath<RenderTexture>("Assets/Fluo/01 Input/Targets/VideoInBlurred.renderTexture");
            var multiplexShader = AssetDatabase.LoadAssetAtPath<Shader>("Assets/Fluo/01 Input/Prefilter/Prefilter.shader");

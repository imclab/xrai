// BrushStrokeTube.shader - URP lit tube brush shader
// Part of Spec 011: OpenBrush Integration
//
// Simple lit shader for 3D tube geometry brushes.
// Supports normal-based lighting for volumetric appearance.

Shader "XRRAI/BrushStrokeTube"
{
    Properties
    {

    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            Varyings vert(Attributes input)
            {
                ...
                // This matches OpenBrush's TbVertToNative() pattern
                #if defined(UNITY_COLORSPACE_GAMMA)
                    output.color = input.color;  // Gamma space: pass through
                #else
                    output.color.rgb = SrgbToLinear(input.color.rgb);  // Linear space: convert

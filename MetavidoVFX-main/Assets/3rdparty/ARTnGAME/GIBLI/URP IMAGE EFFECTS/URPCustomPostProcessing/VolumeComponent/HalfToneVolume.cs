...
{
    [Serializable, VolumeComponentMenu("GIBLI/SleeplessOwl PostProcessing/HalfTone")]
    public sealed class HalfToneVolume : PostProcessVolumeComponent
    {
        ...
        public override InjectionPoint InjectionPoint => InjectionPoint.AfterOpaqueAndSky;//.BeforePostProcess;

        ...
        Pass
        {
		   ...
		   #pragma multi_compile _ _MIXED_LIGHTING_SUBTRACTIVE
            ...
            half4 frag (const v2f i) : SV_Target
            {
				...
				light.shadowAttenuation = light.shadowAttenuation;// lerp(light.shadowAttenuation, 1, GetShadowFade(i.position_ws));
                ...
                attenuation = min(attenuation * light.shadowAttenuation * 1, attenuation);

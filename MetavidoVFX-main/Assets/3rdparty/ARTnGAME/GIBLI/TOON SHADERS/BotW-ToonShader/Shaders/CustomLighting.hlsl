...
void MainLightA_float(float3 WorldPos, out float3 Direction, out float3 Color, out float DistanceAtten, out float ShadowAtten)
{
    ...
    DistanceAtten = 0.5;// mainLight.distanceAttenuation;
    ShadowAtten = DistanceAtten;
#endif
}

Shader "Stylized/Sand"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            v2f vert (a2v v)//(float4 pos : POSITION, float3 normal : NORMAL, float4 tangent : TANGENT)
            {
                v2f o;
            ...
            float4 frag (v2f i) : SV_Target
            {
				...
				return float4(lerp(color, colorFogged, _ApplyFog), 1)*(shadowA*shadowIntensity.x + shadowIntensity.y);
            }
            ENDCG
        }
    }

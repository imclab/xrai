...
half3 LightingExtendedMAIN(BRDFDataExtended brdfData, Light light, half3 normalWS, half3 viewDirectionWS)
{
#ifdef _SUBSURFACE
    half3 internalColor = brdfData.subsurfaceColor;
#else
...
half4 FragmentLitExtended(InputDataExtended inputData, SurfaceDataExtended surfaceData)
{
    ...
    color += LightingExtendedMAIN(brdfData, mainLight, inputData.normalWS, inputData.viewDirectionWS);

...
Shader "DELTation/Toon Shader Custom Instanced"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "./ToonShader/Shaders/ToonShaderForwardPass_AppData.hlsl"
            #include "./ToonShader/Shaders/ToonShaderForwardPass.hlsl"
        ...
        Pass
        {
            ...
            #include "./ToonShaderCustomInstancedInput.hlsl"
            #include "./ToonShader/Shaders/ToonShaderShadowCasterPass.hlsl"
        ...
        Pass
        {
            ...
            #include "./ToonShaderCustomInstancedInput.hlsl"
            #include "./ToonShader/Shaders/ToonShaderMetaPass.hlsl"
        ...
        Pass
        {
            ...
            #include "./ToonShaderCustomInstancedInput.hlsl"
            #include "./ToonShader/Shaders/ToonShaderDepthOnlyPass.hlsl"
        ...
        Pass
        {
            ...
            #include "./ToonShaderCustomInstancedInput.hlsl"
            #include "./ToonShader/Shaders/ToonShaderDepthNormalsPass.hlsl"
            ENDHLSL
        }
    }
    
    CustomEditor "Artngame.GIBLI.DELTation.ToonShader.Editor.ToonShaderEditor"
}

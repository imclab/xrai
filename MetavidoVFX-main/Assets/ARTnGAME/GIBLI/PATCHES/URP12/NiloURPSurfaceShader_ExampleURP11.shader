...
Shader "Universal Render Pipeline/SurfaceShaders/ExampleSurfaceShader URP11"
///////////////////////////////////////////////////////////////////////////////////////////////////////////////
{
    Properties
    {
    ...
    #include "NiloURPSurfaceShaderIncludeURP11.hlsl"
    ...
    #include "NiloPBRLitCelShadeLightingFunctionURP11.hlsl"
    ...
    */
    ...
    void FinalPostProcessFrag(Varyings IN, UserSurfaceOutputData surfaceData, LightingDataA lightingData, inout half4 inputColor)
    {
#if _IsSelected

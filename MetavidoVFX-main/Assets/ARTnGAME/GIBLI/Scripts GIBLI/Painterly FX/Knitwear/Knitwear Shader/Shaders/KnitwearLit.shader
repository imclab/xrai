Shader "Universal Render Pipeline/Knitwear/Lit"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
           ...
           // Tags{"LightMode" = "UniversalForwardOnly"}
            ...
            #include "KnitwearLitInput.hlsl"
            #include "KnitwearLitForwardPass.hlsl"
            ENDHLSL
        }
    ...
    CustomEditor "Artngame.GIBLI.GibliShaderGUI.KnitwearLitShader"
    //CustomEditor "UnityEditor.Rendering.Universal.ShaderGUI.KnitwearLitShader"
}